...
cdresults[1,2] <- ci.smd(smd=cdresults[1,1],n.1=1514, n.2=1514)
...
cdresults[1,4] <- ci.smd(smd=cdresults[1,3],n.1=1514, n.2=1514)
...
cdresults[2,2] <- ci.smd(smd=cdresults[2,1],n.1=1514, n.2=1514)
...
cdresults[2,4] <- ci.smd(smd=cdresults[2,3],n.1=1514, n.2=1514)
...
cdresults[3,2] <- ci.smd(smd=cdresults[3,1],n.1=1514, n.2=1514)
...
cdresults[3,4] <- ci.smd(smd=cdresults[3,3],n.1=1514, n.2=1514)
rownames(jtresults) <- c("Any alcohol consumption","Binge drinking","AUDIT-C Problematic drinking")
